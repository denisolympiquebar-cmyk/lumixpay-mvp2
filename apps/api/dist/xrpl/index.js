...
function createSettlementProvider() {
    ...
    if (provider === "xrpl_testnet") {
        ...
        const { xrplTestnetSettlementProvider } = require("./XrplTestnetSettlementProvider");
        console.info("[Settlement] SETTLEMENT_PROVIDER=xrpl_testnet — real XRPL Testnet settlement active. " +
    ...
    if (provider !== "mock") {
        console.warn(`[Settlement] Unknown SETTLEMENT_PROVIDER value: '${provider}'. ` +
