...
// All monetary values come back as strings from pg (NUMERIC type).
// Use Decimal.js to convert before arithmetic.
// ─────────────────────────────────────────────────────────────────────────────
...
export interface Balance {
  id: string;
  account_id: string;
  available: string; // NUMERIC comes as string from pg
  locked: string;
  updated_at: Date;
}
